...
class MorningAzkraScreens extends StatefulWidget {
  const MorningAzkraScreens({super.key});

  @override
  State<MorningAzkraScreens> createState() => _MorningAzkraScreensState();
}

class _MorningAzkraScreensState extends State<MorningAzkraScreens> {
  final String boxName = 'morning_model_box';
  ...
  Future<void> loadSettings() async {
    final box = await Hive.openBox<MorningModel>(boxName);
    final MorningModel? savedModel = box.get('settings');
