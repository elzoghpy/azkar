...
class AffterPrayAzkar extends StatefulWidget {
  const AffterPrayAzkar({super.key});

  @override
  State<AffterPrayAzkar> createState() => _AffterPrayAzkarState();
}

class _AffterPrayAzkarState extends State<AffterPrayAzkar> {
  final String boxName = 'aftersalah_model_box';
  ...
  Future<void> loadSettings() async {
    final box = await Hive.openBox<AfterSalahModel>(boxName);
    final AfterSalahModel? savedModel = box.get('settings');
        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              childCount: AfterSalahList.length,
