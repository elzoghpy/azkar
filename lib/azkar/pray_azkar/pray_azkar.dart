...
class _PrayAzkarState extends State<PrayAzkar> {
  final String boxsalah = 'salah_model_box';
  ...
  Future<void> loadSettings() async {
    ...
    final SalahModel? savedModel = box.get('settings');
  ...
  List<String> titleSalahList = TitelSalahList;
  List<String> subtitleSalahList = SubTitleSalahlList;
        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              childCount: TitelSalahList.length,
                    ...
                    child: Column(
                      children: [
                        Align(
                          child: Text(
                            textDirection: TextDirection.rtl,
                            TitelSalahList[index],
                            style: const TextStyle(
                                color: MyColors.petrol, fontSize: 21),
                          ),
                        ),
                        Text(
                          textDirection: TextDirection.rtl,
                          SubTitleSalahlList[index],
                          style: const TextStyle(
                              color: MyColors.petrol, fontSize: 21),
                        ),
                      ],
