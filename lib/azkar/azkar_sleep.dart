...
class _SleepAzkarState extends State<SleepAzkar> {
  final String boxName = 'sleep_model_box';
  ...
  Future<void> loadSettings() async {
    final box = await Hive.openBox<SleepModel>(boxName);
    final SleepModel? savedModel = box.get('settings');
