...
class PrayDiedWView extends StatefulWidget {
  const PrayDiedWView({super.key});

  @override
  State<PrayDiedWView> createState() => _PrayDiedWView();
}

class _PrayDiedWView extends State<PrayDiedWView> {
  List<String> PrayDiedWList = praydiedwomenlist;
        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              childCount: PrayDiedWList.length,
